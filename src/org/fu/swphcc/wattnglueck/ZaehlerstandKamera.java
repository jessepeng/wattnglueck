		...
		case R.id.textKameraJa:
			if (alterZaehlerstand != null) {
				if (alterZaehlerstand.getZaehlerstand() > zaehlerstand) {
					OKMessageDialog zaehlerstandNiedrig = new OKMessageDialog("Es wurde ein Z�hlerstand erkannt, der niedriger als dein letzter Z�hlerstand ist. Bitte gib einen h�heren Wert ein.") {
